...
This image shows a scheme of all the methods implemented that can be chosen and the user's inputs:
![Inputs.](Windturbine_noiseprediction.png "This is a sample image.")
